...
const categories: Category[] = [
  {
    ...
    options: [
      ...
      { id: "support-30", label: "Расширенная поддержка +30 дней", price: 3000 },
    ],
  },
  {
    id: "site",
    ...
    options: [
      ...
      { id: "site-portfolio", label: "Портфолио или каталог", price: 2500 },
      { id: "site-quiz", label: "Квиз-форма (опрос с расчётом)", price: 2500 },
      { id: "site-pay", label: "Подключение оплаты на сайте", price: 2500 },
      { id: "site-speed", label: "Ускоренная загрузка и SEO-продвижение", price: 3000 },
      { id: "site-i18n", label: "Мультиязычность", price: 2500 },
    ],
  },
  {
    id: "combo",
    ...
    options: [
      ...
      { id: "combo-pay", label: "Единая оплата через сайт и бот", price: 3000 },
      ...
      { id: "combo-support-30", label: "Расширенная поддержка +30 дней", price: 5000 },
    ],
  },
];
